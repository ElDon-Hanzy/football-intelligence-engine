...
Deno.serve(async(req:Request)=>{
  ...
  try{
    ...
    const[{data:mv},{data:activeMv},{data:decRaw},{data:rr},fixtures,{data:fixturePreds,error:fpe},{data:prefinal}]=await Promise.all([

...
console.log(JSON.stringify({
  ...
  actual_xi: Array.isArray(actualXi) ? actualXi.length : 0,
  actual_bench: Array.isArray(actualBench) ? actualBench.length : 0,
  primary_actual_players: Array.isArray(actualPlayers) ? actualPlayers.length : 0,
  scenario_union_players: Array.isArray(scenarioPlayers) ? scenarioPlayers.length : 0,
  execution_authorized: payload.recommendation?.execution_authorized ?? null,
  recommendation_evidence_rows: Array.isArray(evidence) ? evidence.length : 0,

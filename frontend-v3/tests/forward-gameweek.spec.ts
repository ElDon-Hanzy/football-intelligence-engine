...
const gw5Fixtures = [
  { match_id: 41, fpl_fixture_id: 41, kickoff_time: '2026-09-18T19:00:00Z', home_team: 'Liverpool', away_team: 'Everton', home_short: 'LIV', away_short: 'EVE', finished: false, home_score: null, away_score: null, prediction: { snapshot_id: 9101, source_change_id: 'C0166', captured_at: '2026-09-13T09:03:00Z', markets: { home_win: .58, draw: .24, away_win: .18 }, headline_score: '2-1', headline_score_probability: .11, top_scorelines: [{ score: '2-1', prob: .11 }] } },
  { match_id: 42, fpl_fixture_id: 42, kickoff_time: '2026-09-19T14:00:00Z', home_team: 'Man Utd', away_team: 'Man City', home_short: 'MUN', away_short: 'MCI', finished: false, home_score: null, away_score: null, prediction: { snapshot_id: 9102, source_change_id: 'C0166', captured_at: '2026-09-13T09:03:00Z', markets: { home_win: .34, draw: .30, away_win: .36 }, headline_score: '1-1', headline_score_probability: .12, top_scorelines: [{ score: '1-1', prob: .12 }] } },
];

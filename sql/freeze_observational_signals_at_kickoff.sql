-- Enforce the project invariant: fixture intelligence may update only before kickoff.
-- Historical/team evidence can continue to exist, but no new fixture signal snapshot is appended after kickoff.
